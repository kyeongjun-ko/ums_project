...
public class ReqPUSH0200VO implements Serializable{
	...
	private ReqBodyPUSH0200VO body;
	...
	public ReqBodyPUSH0200VO getBody() {
		return body;
	}


	public void setBody(ReqBodyPUSH0200VO body) {
		this.body = body;
	}
