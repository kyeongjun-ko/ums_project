...
public class VmsVO {
	...
	private String counselorDtmf;
	private String counselorNumber;
	
	private String relistenCount;
	private String ktOfficeCode;
	private String cdrId;
	
	private String smsplusMsg;
	...
	public String toString() {
		return "VmsVO [userId=" + userId + ", msgSubtype=" + msgSubtype
				+ ", scheduleType=" + scheduleType + ", destType=" + destType
				+ ", mentType=" + mentType + ", voiceType=" + voiceType
				+ ", subject=" + subject + ", nowDate=" + nowDate
				+ ", sendDate=" + sendDate + ", callback=" + callback
				+ ", replyType=" + replyType + ", replyCount=" + replyCount
				+ ", counselorDtmf=" + counselorDtmf + ", counselorNumber="
				+ counselorNumber + ", relistenCount=" + relistenCount
				+ ", ktOfficeCode=" + ktOfficeCode + ", cdrId=" + cdrId
				+ ", smsplusMsg=" + smsplusMsg + ", headerMsg=" + headerMsg
				+ ", tailMsg=" + tailMsg + ", ttsMsg=" + ttsMsg
				...
				+ ", pagingHtml=" + pagingHtml + ", usrGrpList=" + usrGrpList
				+ "]";
	}
	...
	public String getCounselorDtmf() {
		return counselorDtmf;
	}
	public void setCounselorDtmf(String counselorDtmf) {
		this.counselorDtmf = counselorDtmf;
	}
	...
	public String getRelistenCount() {
		return relistenCount;
	}
	public void setRelistenCount(String relistenCount) {
		this.relistenCount = relistenCount;
	}
	...
	public String getSmsplusMsg() {
		return smsplusMsg;
	}
	public void setSmsplusMsg(String smsplusMsg) {
		this.smsplusMsg = smsplusMsg;
	}
