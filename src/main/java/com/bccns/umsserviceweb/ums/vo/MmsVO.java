...
public class MmsVO {
	...
	private String mmsMsg;  //MMS에서만 사용
	private String contentCount; //MMS에서만 사용
	private String contentData; //MMS에서만 사용
	...
	private String msgType; //MMS에서만 사용
	...
	public String toString() {
		return "MmsVO [userId=" + userId + ", scheduleType=" + scheduleType
				+ ", subject=" + subject + ", nowDate=" + nowDate
				+ ", sendDate=" + sendDate + ", callback=" + callback
				+ ", destCount=" + destCount + ", destInfo=" + destInfo
				+ ", mmsMsg=" + mmsMsg + ", contentCount=" + contentCount
				+ ", contentData=" + contentData + ", ktOfficeCode="
				+ ktOfficeCode + ", cdrId=" + cdrId + ", reserved1="
				+ reserved1 + ", reserved2=" + reserved2 + ", reserved3="
				+ reserved3 + ", reserved4=" + reserved4 + ", reserved5="
				+ reserved5 + ", reserved6=" + reserved6 + ", reserved7="
				+ reserved7 + ", reserved8=" + reserved8 + ", reserved9="
				+ reserved9 + ", sendStatus=" + sendStatus + ", sendCount="
				+ sendCount + ", sendResult=" + sendResult + ", sendProcTime="
				+ sendProcTime + ", msgType=" + msgType + ", stdId=" + stdId
				+ ", reserveYear=" + reserveYear + ", reserveMonth="
				+ reserveMonth + ", reserveDay=" + reserveDay
				+ ", reserveHour=" + reserveHour + ", reserveMin=" + reserveMin
				+ ", repeatType=" + repeatType + ", repeatHour=" + repeatHour
				+ ", repeatMin=" + repeatMin + ", repeatDay=" + repeatDay
				+ ", repeatWeek=" + repeatWeek + ", msgBoxList=" + msgBoxList
				+ ", totalCount=" + totalCount + ", pagingHtml=" + pagingHtml
				+ ", usrGrpList=" + usrGrpList + ", file_name="
