...
public class SearchMySvcVO extends PaginationInfo {
	...
	public String toString() {
		return "SearchMySvcVO [userId=" + userId + ", smsSendCnt=" + smsSendCnt
				...
				+ ", umsUserVO=" + umsUserVO + ", transUseList=" + transUseList
				+ "]";
	}
