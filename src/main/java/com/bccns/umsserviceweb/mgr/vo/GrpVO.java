...
public class GrpVO extends PaginationInfo  {
	...
	public String toString() {
		return "GrpVO [grpArNo=" + Arrays.toString(grpArNo) + ", grpArCd="
				+ Arrays.toString(grpArCd) + ", rowNumber=" + rowNumber
				+ ", userId=" + userId + ", grpNo=" + grpNo + ", grpCd="
				+ grpCd + ", grpNm=" + grpNm + ", note=" + note + ", instDt="
				+ instDt + ", instId=" + instId + ", updtDt=" + updtDt
				+ ", updtId=" + updtId + ", searchType=" + searchType
				+ ", searchName=" + searchName + ", grpCdNm=" + grpCdNm
				+ ", grpCnt=" + grpCnt + ", regFg=" + regFg + ", usrGrpList="
				+ usrGrpList + "]";
	}
