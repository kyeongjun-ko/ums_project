...
<input type="hidden" name="MSGRES" id="MSGRES" value="Y" />
	...
	<div class="col-md-4 mbox">	
		...
		<div class="mob">
			<div id="CONTENT_BG" class="mbody">
				<textarea name="smsMsg" id="CONTENT" readonly></textarea>
				<div class="mfoot">
		...
		<div class="checkbox">
		    <label>
			    <input type="checkbox" name="msgSav"  id="msgSav" value="N" disabled>메시지 저장
		    </label>
		    <label>
