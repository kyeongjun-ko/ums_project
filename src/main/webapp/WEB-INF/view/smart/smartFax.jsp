	...
	<div class="col-md-4 mbox">	
		...
		<div class="mob">
			<div id="CONTENT_BG" class="mbody">
				...
				<div class="mfoot">
					<em class="mtype sfx">SMART FAX</em>
