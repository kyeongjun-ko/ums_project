		...
		<div class="col-md-12 tcon">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">예약 내역 조회</h3>
				</div>
					...
					<div class="form-inline">
						...
						<div class="form-group pname">
							<select name="searchType" id="searchType" class="form-control" value="${searchTransResvVO.searchType}">
								<option value=""  <c:if test="${searchTransResvVO.searchType == ''}">selected="selected" </c:if> >전체</option>
								<option value="01" <c:if test="${searchTransResvVO.searchType == '01'}">selected="selected" </c:if> >제목</option>
							</select>
						</div>			
						<div class="form-group searchtit">	
							<input type="text" class="form-control" placeholder="검색할 제목" name="searchName" value="${searchTransResvVO.searchName}">			
						</div>
