...
function goAddrExcelUplodPopup() {
    ...
    //windowOpenPost(f, url, null, "yes", title, 500, 500, 50, 50, "yes");
    poptarget = window.open("/ums/addrXlsPopup2"  , title, status);
...
function CheckSendForm() {
	...
	if( document.getElementById("CONTENT").value.trim() == "" || document.getElementById("CONTENT").value.trim() == Util.DefaultKeyword ) {
	...
	if( getByteLength(document.getElementById("CONTENT").value.replace(/\r/g, "")) > 80 ) {
	...
	if(Check2Replace() == true) {
		...
		}else if(confirm("정말 보내시겠습니까?")==true){
			strUrl = "/ums/sendProc2";
		}else{
           return false;
	}
...
<div class="col-md-9">
 <div class="col-md-12 tits">
		...
		<ol class="breadcrumb">
			...
			<li class="active">SMS/LMS 대량발송</li>
		</ol>
		<div class="hbg">
...
<div class="col-md-4" style="width:30%; float:right; margin-top:11px; padding:0;">
...
<input type="hidden" name="RECEIVER_TYPE" id="RECEIVER_TYPE" value="E" />
...
<input type="hidden" name="SMSSPLIT" id="SMSSPLIT" value="N" />
	...
	<div class="col-md-4" style="width:70%; margin-top:10px;">
	  <table style="width:100%">
	  <tr>
	  <td style="width:33.3333%; padding:2px;"><div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title"><spring:message code="callback"/></h3>
			</div>
			<div class="panel-body" style="height:80px; padding:23px;">
	  ...
	  <td style="width:33.3333%; padding:2px;"><div class="panel panel-default">
			...
			<div class="panel-body" style="height:80px;">
				<textarea class="form-control" name="subject" id="" rows="2" placeholder="제목을 입력해 주세요."></textarea>
			</div>
		</div>	</td>
	...
	<div class="panel panel-default">
			...
			<span class="btns"> 
				...
				<span class="btns" style="margin-bottom:5px;" >
		...
		<!-- 	<div class="panel-body">
				<div class="form-inline phn">
					<div class="form-group">
						...
						<input type="text" id="AddReceiveContent" name="AddReceiveContent"  onfocus="defaultMsgFocus(this, '내용');this.select()" onblur="defaultMsgBlur(this, '내용')" class="form-control content" placeholder="내용" />		
						<input type="hidden" name="AddSmartPhnYn" id="AddSmartPhnYn" />
					</div>
					<button class="btn btn-second"  onclick="javascript:addPhoneNum();">+</button>
				</div>
			</div>-->  
			<div class="panel-body divider" style="height:370px;">
		...
		<div class="col-md-4 mbox" style="width:80%; margin-left:178px;">				
		 <button onclick="CheckSendForm();" style="width:20%;" class="btn btn-primary btn-lg"><spring:message code="send"/></button>		 
		 <button onclick="document.location.reload();" style="width:20%;" class="btn btn-primary btn-lg">재입력</button>		
	</div>		
</form>	
